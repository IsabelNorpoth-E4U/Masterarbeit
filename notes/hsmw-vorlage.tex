...
% für Code-Listings (\begin{lstlisting})
\usepackage{listings}
% Zusätzliche Einstellungen für Code-Listings: Zeilenumbruch innerhalb von langen Zeilen
\usepackage{xcolor}
\lstset{
  breaklines=true,
  breakatwhitespace=true,
  postbreak=\mbox{\textcolor{gray}{\ensuremath{\hookrightarrow}}},
...
% Make inline verbatim breakable: use fvextra + shortvrb and define | as short verb delimiter
\usepackage{fvextra,shortvrb}
...
defernumbers=true, % defer numbering until printing bibliography
natbib=true, % provide \citep / \citet compatibility
...
\addbibresource{hsmw-literature.bib}
...
\Fakultaet{Angewandte Computer- und Biowissenschaften} % Voreinstellung: CB
...
\Tag{18}
\Monat{November}
\Jahr{2026} % für Titelseiten und bibliographische Angaben
...
\input{chapter/03_Prompt_Injection.tex}
\input{chapter/04_Analyse_Chatbot.tex}
\input{chapter/05_Schutzmaßnahmen.tex}
