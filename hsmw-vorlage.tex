\documentclass[nomenclature, norefpage, oneside, glossary, hypertext,multiauthor]{C:/Users/inorpoth/OneDrive - ALTEN Group/Dokumente/Masterarbeit/settings/hsmw-class}
...
\lstset{
    style=mystyle, % falls du deinen definierten Stil nutzt
    breakatwhitespace=false,
    breaklines=true,
    basicstyle=\ttfamily,    % Zwingt LaTeX, eine nicht-proportionale Schrift (wie Courier) zu nehmen
    columns=fullflexible,    % Sorgt dafür, dass der Zeichenabstand ganz natürlich bleibt
    keepspaces=true          % Erhält absichtliche Leerzeichen im Code, anstatt sie zu ignorieren
}
...
\addbibresource{/C:/Users/inorpoth/OneDrive - ALTEN Group/Dokumente/Masterarbeit/hsmw-literatur.bib}
...
\Art{Masterarbeit} % Protokoll / Bachelorarbeit / Masterarbeit / ...
...
\Thema{Untersuchung und Entwicklung von Schutzmaßnahmen gegen indirekte Prompt-Injection-Angriffe bei Tool Calling im Anwendungsfall eines unternehmensinternen Chatbot}
%\Unterthema{Für alle \LaTeX{}-Freunde}

% Ihr Studiengang:
\Studiengang{Master Cybercrime/Cybersecurity}

% Ihre Seminargruppe
\Seminargruppe{CY24w1-M}

\Fakultaet{Fakultät Angewandte Computer- und Biowissenschaften} % Voreinstellung: CB

\Erstpruefer{Prof. Dr. rer. pol. Ronny Bodach} % Prof. der Hochschule Mittweida
\Zweitpruefer{M. Sc. Fabio Rodrigues} % Externer Betreuer

\Datum{18.11.2026} % für Selbstständigkeitserklärung
...
\input{chapter/03_Prompt_Injection}

\input{chapter/04_Analyse_Chatbot}
...
%\textit{figs-latex.png} & eine Abbildung\\
%\end{tabular}
%
...
%
%Die Abb. \ref{figs:latex} zeigt das \LaTeX{}-Dokument, mit dem wir im Modul \enquote{Wissenschaftliches Schreiben} begonnen haben. Abbildungen können Sie als PDF- oder PNG-Datei hinterlegen.
%
%\begin{figure}[h]
%    \centering
%    \includegraphics[width=.7\columnwidth]{/C:/Users/inorpoth/OneDrive - ALTEN Group/Dokumente/Masterarbeit/settings/figs-latex}
