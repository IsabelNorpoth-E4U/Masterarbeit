...
\title[Template and Information for Writing Protocols, Reports and Theses]{Vorlage und \textit{Informationen} für das Verfassen von Protokollen, Belegen und Abschlussarbeiten}
...
\partnerlogo{logo-e4u.jpg}% Partnerlogo (Path to logo file)
...
\input{chapter/05_Schutzmassnahmen}
